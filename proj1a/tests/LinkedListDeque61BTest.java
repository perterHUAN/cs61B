...
public class LinkedListDeque61BTest {
    ...
    public void testGet() {
        ...
        assertWithMessage("索引超过队列长度应返回NULL").that(lld1.get(234)).isNull();
        assertWithMessage("索引为负数时应返回NULL").that(lld1.get(-1)).isNull();
    ...
    public void testGetRecursive() {
        ...
        assertWithMessage("索引超过队列长度应返回NULL").that(lld1.getRecursive(234)).isNull();
        assertWithMessage("索引为负数时应返回NULL").that(lld1.getRecursive(-1)).isNull();
